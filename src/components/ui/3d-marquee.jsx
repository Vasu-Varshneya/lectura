...
export const ThreeDMarquee = ({ images, className }) => {
  // Create duplicated images to ensure we have enough to fill all columns
  const duplicatedImages = [...images, ...images, ...images]; // Triple the images

  // Split into 4 columns more evenly
  const columns = [[], [], [], []];
